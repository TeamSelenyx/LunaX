 ...
 *
 * It also shows up when a survival player pays a beacon (the payment item is "destroyed" as it's consumed) - that
 * case is exempted from the finite-resources check below via the currently open BeaconInventory.
 */
